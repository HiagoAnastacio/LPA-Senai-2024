programa
{
	...
	funcao inicio()
	{
		...
		//inteiro gg = u.sorteia(20, 200)
		//inteiro wp = u.sorteia(20, 200)
		//inteiro h = u.sorteia(20, 200)
		//inteiro H = u.sorteia(20, 200)
		...
		enquanto (nao 	t.tecla_pressionada(t.TECLA_ESC) )
		{
			...
			para (inteiro i=0 ; i<= largura_janela/ /*gg*/20 ; i++)
			{
				para (inteiro j=0; j<= altura_janela/ /*wp*/ ; j++)
				{
					g.desenhar_retangulo (
					i*20 + 20*m.cosseno((k+j*/*h*/20)*2*m.PI/360),
					j*20 + 20*m.seno((k+i*/*H*/20)*2*m.PI/360), 
